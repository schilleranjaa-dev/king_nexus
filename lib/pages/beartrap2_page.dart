...
class BearTrap2Page extends StatefulWidget {
  const BearTrap2Page({super.key});

  @override
  State<BearTrap2Page> createState() => _BearTrap2PageState();
}

class _BearTrap2PageState extends State<BearTrap2Page> {
  ...
  final String eventId = 'beartrap2';
  ...
  Future<void> loadPageData() async {
    try {
      ...
      final time =
          await _firestoreService.loadBearTrap2Time();
  ...
  Future<void> changeStartTime() async {
    ...
    final selectedTime = await showTimePicker(
      ...
      helpText: 'Startzeit für Bärenfalle 2',
    ...
    try {
      await _firestoreService.saveBearTrap2Time(
        '$formattedTime UTC',
      );
          ...
          : ListView(
              ...
              children: [
                ...
                infoCard(
                  ...
                  title: 'Regeln',
                  text:
                      'Hier kommen später die Regeln für Bärenfalle 2 hinein.',
                ),
